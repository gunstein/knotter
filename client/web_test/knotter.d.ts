...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h5a9cce09e0b6fedb: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h88c43fbe309353bb: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h73e692f4f956cc1a: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h5586a67bedf2005e: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__he1183b8dabe4d6fd: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h13739b5e8a797864: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hc58555589fbccf3e: (a: number, b: number, c: number) => void;
